...
- 除本节已批准的 WorldDefinition 内容绑定/初始化/operation 所有者、InitialRelation/玩家起点 `InitialVisibility` 与 fields、MaterializationProfile asset provider 引用外，新增协议字段或 EffectOp 类型仍需用户批准
