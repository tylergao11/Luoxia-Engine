...
玩家在 GUI 选择 System + interaction_kind，并输入对 System 说的话
  ...
  → director.dialogue_events 独立观察已提交 transcript 并决定是否提出 EventCardSemanticDraft
  → 玩家亲自完成所需世界行为
