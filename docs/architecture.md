...
玩家在 GUI 选择 System + interaction_kind，并输入对 System 说的话
  ...
  → director.dialogue_events 独立观察已提交 transcript；remaining>0 时恰好一张 EventCardSemanticDraft（选项在 result_options）
  → 玩家亲自完成所需世界行为
